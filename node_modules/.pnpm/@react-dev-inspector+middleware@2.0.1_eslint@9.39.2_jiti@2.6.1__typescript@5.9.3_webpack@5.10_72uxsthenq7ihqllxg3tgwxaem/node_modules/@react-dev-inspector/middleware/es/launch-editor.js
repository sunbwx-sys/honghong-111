...
import { queryParserMiddleware, } from './query-params-parser';
const reactLaunchEditorMiddleware = createReactLaunchEditorMiddleware();
export const launchEditorMiddleware = (req, res, next) => {
    var _a, _b;
    if (!((_a = req.url) === null || _a === void 0 ? void 0 : _a.startsWith(launchEditorEndpoint))) {
        return next();
    }
    queryParserMiddleware(req, res, () => { });
    if (!((_b = req.query) === null || _b === void 0 ? void 0 : _b.fileName)) {
        return next();
    }
...
export const createLaunchEditorMiddleware = () => launchEditorMiddleware;
