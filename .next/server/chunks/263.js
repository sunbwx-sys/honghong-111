"use strict";exports.id=263,exports.ids=[263],exports.modules={34263:(a,b,c)=>{c.r(b),c.d(b,{blogPosts:()=>d,getAllPosts:()=>f,getPostBySlug:()=>e});let d=[{slug:"golden-30-minutes",title:"吵架之后的黄金 30 分钟",summary:"吵架了怎么办？别急着道歉也别急着冷战，先搞懂这 30 分钟里对方脑子里在想什么……",readTime:4,date:"2025-01-15",content:`吵架刚结束的那 30 分钟，堪称恋爱关系里最危险的"雷区时段"。
...
这才是道歉真正的意义。`}];function e(a){return d.find(b=>b.slug===a)}function f(){return d}}};