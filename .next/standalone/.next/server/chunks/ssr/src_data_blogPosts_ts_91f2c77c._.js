module.exports=[51433,a=>{"use strict";let b=[{slug:"golden-30-minutes",title:"吵架之后的黄金 30 分钟",summary:"吵架了怎么办？别急着道歉也别急着冷战，先搞懂这 30 分钟里对方脑子里在想什么……",readTime:4,date:"2025-01-15",content:`吵架刚结束的那 30 分钟，堪称恋爱关系里最危险的"雷区时段"。
...
记住：30 分钟之内，情绪还在高位。这个时候拼的不是道理，是态度。态度到位了，后面什么都好说。态度不到位，后面的每一句"我错了"都会变成"我错了行了吧"。`},{slug:"you-are-right",title:"为什么「你说得对」是最烂的回复",summary:'三个字，能把本来快好的天聊崩。它到底有什么魔力？让我们一起拆解这句"敷衍之王"。',readTime:3,date:"2025-01-12",content:`"你说得对。"
...
如果是后者——别偷懒。认真说几句，比什么都强。`},{slug:"apology-guide",title:"道歉的正确打开方式",summary:'"我错了"三个字说出来容易，但管用吗？教你一套道歉公式，让 TA 一秒心软。',readTime:5,date:"2025-01-10",content:`"对不起。"
"我错了。"
"下次不会了。"
...
这才是道歉真正的意义。`}];function c(a){return b.find(b=>b.slug===a)}function d(){return b}a.s(["blogPosts",0,b,"getAllPosts",()=>d,"getPostBySlug",()=>c])}];

//# sourceMappingURL=src_data_blogPosts_ts_91f2c77c._.js.map